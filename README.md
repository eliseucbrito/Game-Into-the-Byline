...
- Jogabilidade:
    ...
    - Geração do _flash_ sob eixos cartesianos usando as setas direcionais;
...
- Mecânicas:
    - Os monstros (Billy e Bob) se deslocam pelo labirinto da mesma forma que o player e seguindo a rota mais curta entre sua posição e o player:
    ...
    - O player perde quando um dos mosntros colide com ele, zerando a sua pontuação e finalizando o jogo;
...
- Tuplas:
    - Tudo relacionado à coordenadas, dimensões, resolução e cores.
- Condicionais:
    - Tudo relacionado à comparação de valores ao longo de todo o código;
    - Comparação entre as posições do _player_ e do _flash_ com outros objetos, como monstros, baús e porta;
    - Comparar que cenário de jogo está o _player_, como menu inicial, jogo em si e cenário de morte/vitória.
- Loops:
    - 
